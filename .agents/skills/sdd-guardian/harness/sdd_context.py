#!/usr/bin/env python3
"""SDD context harness for the MRRC-FT8 codebase.
...
Commands:
  ...
  sdd <REF|term>                 Print one SDD item (AD-011, NFR-060, UC-005,
                                 R4, I8, SC8, A4, 9.6, ch15) or search terms.
...
def _refs_present(text: str) -> set[str]:
    """SDD ref idents found in a document (AD-014, NFR-060, UC-005, R4, I8,
...
def cmd_prime(reg: dict) -> int:
    ...
    print("═══ SDD-GUARDIAN — MRRC-FT8 design harness (SDD " + reg["sdd_version"] + ") ═══")
    ...
    print("")
    print("Lifecycle: brief → design (ADs, NFRs, risks, open issues I8-I11) → implement")
    print("(minimal diffs, module conventions) → test (pytest, hardware-free boundaries, sync")
