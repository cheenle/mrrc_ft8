...
def test_waterfall_resize_compares_floored_dimensions() -> None:
    ...
    js = (STATIC / "js" / "waterfall.js").read_text(encoding="utf-8")
...
def test_decode_feed_is_chronological_with_slot_separators() -> None:
    ...
    candidates = (STATIC / "js" / "candidates.js").read_text(encoding="utf-8")
...
def test_candidates_render_band_activity_columns() -> None:
    js = (STATIC / "js" / "candidates.js").read_text(encoding="utf-8")
...
def test_auth_death_returns_to_login() -> None:
    ...
    streams_js = (STATIC / "js" / "streams.js").read_text(encoding="utf-8")
...
def test_safety_bar_offers_clear_fault_button() -> None:
    ...
    js = (STATIC / "js" / "safety.js").read_text(encoding="utf-8")
...
def test_stale_display_is_visibly_marked() -> None:
    ...
    wf = (STATIC / "js" / "waterfall.js").read_text(encoding="utf-8")
